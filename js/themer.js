...
const _state = {
  ...
  outlineWidth: 0, outlineStyle: 'none', outlineColor: '#b8860b', outlineOffset: 0,
  padding: 0, margin: 0,
...
export function initThemer({ setCssContent }) {
  ...
  _bindRange('outlineWidth', 'px'); _bindColor('outline'); document.getElementById('themer-outline-style').addEventListener('change', _onPropChange); _bindRange('outlineOffset', 'px');
...
function _generate() {
  ...
  if (s.outlineOffset && s.outlineOffset !== 0) lines.push('outline-offset: ' + s.outlineOffset + 'px;');
